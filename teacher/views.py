...
def teacher_registration(request):
    ...
    login_form = forms.TeacherLoginForm
    if request.method == 'POST':
        ...
        login_form = forms.TeacherLoginForm(request.POST)
        if form.is_valid() and education_form.is_valid() and training_form.is_valid() and job_form.is_valid() and experience_form.is_valid() and login_form.is_valid():
